...
function SelectedToolsPreview({ tools }: SelectedToolsPreviewProps): ReactNode {
  ...
  return (
    <span className="flex items-center gap-1.5 whitespace-nowrap max-sm:gap-1">
      ...
      {overflowCount > 0 && (
        <span className="flex h-5 min-w-4 items-center justify-center text-[11px] leading-none text-muted-foreground tabular-nums max-sm:-ml-[1.2px] max-sm:h-4 max-sm:min-w-3.5 max-sm:text-[10px]">
          +{overflowCount}
        </span>
      )}
    </span>
