...
export function DitheringShader({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (u.u_colorBack) ctx.uniform4fv(u.u_colorBack, hexToRgba(bg));
      if (u.u_colorFront) ctx.uniform4fv(u.u_colorFront, hexToRgba(fg));
      if (u.u_shape) ctx.uniform1f(u.u_shape, 4);
      if (u.u_type) ctx.uniform1f(u.u_type, 4);
