...
const DEFAULT_LABELS: Record<string, { label: string; badge?: string }> = {
  ...
  "thinkingmachines/inkling-low": { label: "Inkling", badge: "low" },
  "thinkingmachines/inkling-medium": { label: "Inkling", badge: "medium" },
  "thinkingmachines/inkling-high": { label: "Inkling", badge: "high" },
